Packaging and Deploying FeatureSelect
...
2. Installing the FeatureSelect Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   FeatureSelect. If you do not have write permissions, copy all its contents to a 
...
3. Using the FeatureSelect Package

The FeatureSelect package is on your Python path. To import it into a Python script or 
   session, execute:
